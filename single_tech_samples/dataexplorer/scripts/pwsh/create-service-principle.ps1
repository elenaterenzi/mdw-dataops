...
$servicePrincipleName = Read-Host -Prompt 'Input the Service Principle name (default: MyServicePrinciple-ForProjectXXX-ForServices-SPId)'
if ([string]::IsNullOrWhiteSpace($servicePrincipleName))
{
    $servicePrincipleName = 'MyServicePrinciple-ForProjectXXX-ForServices-SPId'
}
